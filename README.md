...
### Link to your Trello Board here: https://trello.com/b/ZvfNlc8Y/mark-nc-games-project
...
Just to note, the PGDATABASE destinations have been added to a .env file which won't get pushed through to github as they get included in the .gitignore section. If one would like to seed data and create their own database using these programs, they must create their own seperate .test and .development .env files to work with.
